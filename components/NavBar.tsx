...
const NavBar = () => {
  ...
  return (
    <div className="h-16 flex  items-center xl:px-32 lg:px-32 md:px-18 px-5">
      <div>
        <Image src={logo} alt="Logo" height={24} className="opacity-50" />
      </div>
      <div className="ml-auto relative w-40 md:w-64">
        <div className="relative">
          ...
          <Input
            type="search"
            placeholder="Search"
            className="pl-10 border-none bg-gray-200 w-full rounded-lg h-8 md:h-8 lg:h-10 font-SFPro"
          />
        </div>
      </div>
